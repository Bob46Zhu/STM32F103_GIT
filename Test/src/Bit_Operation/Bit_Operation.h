...
// 这里只定认了GPIO ODR和IDR这个两寄存器的位带别名区地址，其他寄存器的没有定义
 ...
 *如果是2，+0x02000000 则=0X2200 0000，即是SRAM，如果是4，+0x0200 0000 则=0x4200 0000,即是外设
 *
...
// 单独操作GPIO的某一个IO口，n(0,1,2...16),n表示具体是哪一个IO口
